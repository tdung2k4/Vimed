...
| Metric | V1 | V2 | V3 |
|---|---:|---:|---:|
| Precision | **0,9856** | 0,8479 | 0,9832 |
| Recall | **0,4236** | 0,3947 | 0,4023 |
| F1 | **0,5916** | 0,5357 | 0,5695 |

- Precision rất cao ở V1/V3: khi model dùng keyword được theo dõi, phần lớn keyword cũng có ở reference.
- Recall chỉ 0,39–0,42: model bỏ hơn nửa keyword reference.
- V2 precision thấp hơn vì thêm nhiều keyword/claim không có trong reference.

Đây là dấu hiệu **omission**: report ngắn và mất nhiều phát hiện. V1 tốt nhất tương đối nhưng recall 0,4236 vẫn không đủ cho report y tế.
